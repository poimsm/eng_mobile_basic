...
//                     width: 15,
//                   ),
//                   homeState.word!.meaning != null && homeState.showMeaningBtn
//                       ? InkWell(
//                           onTap: () {
...
//     List<MeaningElem> meaning = wordCopy.meaning!;

//     bool hasHidden(List<MeaningElem> elems, String type) {
//       final result = elems.where((el) => el.hidden && el.type == type).toList();
//       return result.isNotEmpty;
//     }

//     List<MeaningElem> unhideElem(List<MeaningElem> elems, String type) {
//       List<MeaningElem> result = [];
//       bool found = false;
//       int index = 0;
//       for (var i = 0; i < elems.length; i++) {
//         if (elems[i].hidden && elems[i].type == type && !found) {
//           final el = elems[i].copyWith(hidden: false);
//           result.add(el);
//           found = true;
//           index = i;
//         } else {
...
//       final elem = result.removeAt(index);
//       result.add(elem);
//       return result;
//     }
...
//           Widget examples(List<MeaningExample> examples) {
//             return SizedBox(
//               height: 200,
//               child: ListView(
...
//           Widget example(MeaningElem example) {
//             return Card(
//               elevation: 3,
//               child: Column(
//                 children: [
...
//                     ),
//                     child: Text(
//                       'Esta es una traduccion a tu idioma preferido para practicar que es un poco.',
...
//                     padding: EdgeInsets.all(10),
//                     alignment: Alignment.centerRight,
//                     child: Icon(LineIcons.volumeUp, size: 33),
//                   )
//                 ],
//               ),
//             );
...
//           Widget example6(MeaningElem example) {
//             return Container(
...
//                                   .speak(example.value, speed: 0.97);
//                             }
//                           },
...
//                     ),
//                     child: Text(
//                       'Esta es una traduccion a tu idioma preferido para practicar que es un poco mas largo de lo normal porque si.',
//                       style: TextStyle(fontSize: 16, color: Colors.blueGrey),
//                     ),
//                   )
//                 ],
...
//           Widget example3(MeaningElem example) {
//             return Container(
//               padding: EdgeInsets.symmetric(vertical: 5),
//               width: double.infinity,
//               child: Stack(
...
//           Widget example7(MeaningElem example) {
//             return Container(
//               padding: EdgeInsets.symmetric(vertical: 5),
//               width: double.infinity,
//               child: Row(
...
//           Widget example5(MeaningElem example) {
//             return Container(
//               padding: EdgeInsets.symmetric(vertical: 5),
//               width: double.infinity,
//               child: Row(
...
//                   Column(
//                     children: [
//                       Icon(LineIcons.volumeUp, size: 30),
//                       SizedBox(
//                         height: 7,
//                       ),
//                       Icon(Icons.translate, size: 28)
//                     ],
//                   )
//                 ],
//               ),
...
//           Widget example4(MeaningElem example) {
//             return Container(
//               padding: EdgeInsets.symmetric(vertical: 5),
//               width: double.infinity,
//               child: Row(
...
//                           ref
//                               .read(homeProvider.notifier)
//                               .playVoice(example.voiceUrl!, shouldStop: false);
//                         } else {
//                           ref
//                               .read(homeProvider.notifier)
//                               .speak(example.value, speed: 0.97);
...
//           Widget example2(MeaningElem example) {
//             return Container(
//               padding: EdgeInsets.symmetric(vertical: 5),
//               width: double.infinity,
//               child: Row(
...
//           Widget explanation(MeaningElem content) {
...
//                     ...List.generate(meaning.length, (i) {
//                       if (meaning[i].type == 'icon') {
//                         return Column(
//                           children: [
//                             image(meaning[i].value),
//                             SizedBox(height: 0),
//                           ],
//                         );
//                       }
...
//                     ),
//                     // Text('''
//                     //   As I left my house, I noticed that the sky was cloudy, and a few drops of rain started to fall. I thought it was just a passing shower, so I decided to go for a walk. However, as I walked down the street, the rain intensified, and soon, a downpour was pouring down on me. I tried to find shelter under a tree, but it didn't offer much protection. The downpour was so heavy that it felt like a thousand needles hitting my skin.
//                     //   But then I saw a small café across the street. I ran towards it, ignoring the traffic and the puddles. When I reached the door, I realized that many other people had the same idea. The café was packed, and there was no empty seat. I looked outside, hoping the downpour would stop, but it didn't.
//                     //   '''),
...
//                       if (meaning[i].type == 'definition' &&
//                           !meaning[i].hidden) {
//                         widgetResolve = definition(meaning[i].value);
//                         return Column(
//                               children: [
//                                 widgetResolve,
//                                 SizedBox(height: 10),
...
//                       // if (meaning[i].type == 'story' && !meaning[i].hidden) {
//                       //   widgetResolve = story(meaning[i]);
//                       // }

//                       // if (meaning[i].type == 'collocations' &&
//                       //     !meaning[i].hidden) {
//                       //   widgetResolve = collocation(meaning[i].collocationList);
//                       // }

//                       if (meaning[i].type == 'example' && !meaning[i].hidden) {
//                         widgetResolve = example(meaning[i]);
//                       }

//                       if (meaning[i].type == 'explanation' &&
//                           !meaning[i].hidden) {
//                         widgetResolve = explanation(meaning[i]);
//                       }

//                       bool isNewSection = (i + 1 < meaning.length) &&
//                           (meaning[i].type != meaning[i + 1].type);

//                       return widgetResolve == null
//                           ? Container()
//                           : Column(
//                               children: [
//                                 widgetResolve,
//                                 SizedBox(height: isNewSection ? 20 : 10),
//                               ],
//                             );
//                     }),
//                     SizedBox(
//                       height: 20,
//                     ),
//                     if (hasHidden(meaning, 'example'))
//                       InkWell(
//                         onTap: () {
//                           meaning = unhideElem(meaning, 'example');
//                           setState(() {});
//                         },
//                         child: Container(
//                           width: 300,
...
//                               'Make Example 👌',
//                               style: TextStyle(
//                                   fontSize: 18.5, color: Colors.black87),
//                             ),
//                           ),
//                         ),
//                       ),
...
//                       height: 20,
//                     ),
//                     if (hasHidden(meaning, 'explanation'))
//                       InkWell(
//                         onTap: () {
//                           meaning = unhideElem(meaning, 'explanation');
//                           setState(() {});
//                         },
//                         child: Container(
//                           width: 300,
